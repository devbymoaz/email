  ...
  return (
    ...
    >
      ...
      <Box className={classes.root}>
        <Box sx={{ pt: 10 }}>
          <Box sx={{ pt: { xs: 2, md: 10 }, px: { xs: 2, md: 4 }, mt: 3 }}>
            <Typography variant='h2' sx={{ width: { xs: '80%', md: '40%', lg: '30%' }, fontSize: { xs: '3rem', md: '4.5rem' }, fontWeight: 'bold' }}>
              Buy & Sell your Products here
            </Typography>
            <Typography variant='h6' sx={{ width: { xs: '80%', md: '40%', lg: '30%' }, ml: 2 }}>
